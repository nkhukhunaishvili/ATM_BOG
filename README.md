...
I am not sure that using LSTM was right in this situation. Feedforeward NN might be a better option. So the model is very far from perfect. But this approach by AWS is worth invetsigating, I think.
